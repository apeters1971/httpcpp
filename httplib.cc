...
Result ClientImpl::Propfind(const std::string &path) {
  return Propfind(path, Headers(), Progress());
}

Result ClientImpl::Propfind(const std::string &path, Progress progress) {
  return Propfind(path, Headers(), std::move(progress));
}

Result ClientImpl::Propfind(const std::string &path, const Headers &headers) {
  return Propfind(path, headers, Progress());
}
...
Result ClientImpl::Propfind(const std::string &path, const Params &params,
                              const Headers &headers, Progress progress) {
...
Result Client::Propfind(const std::string &path) { return cli_->Propfind(path); }
Result Client::Propfind(const std::string &path, const Headers &headers) {
  return cli_->Propfind(path, headers);
}
Result Client::Propfind(const std::string &path, Progress progress) {
...
Result Client::Propfind(const std::string &path,
                          ContentReceiver content_receiver) {
...
Result Client::Propfind(const std::string &path, const Params &params,
                          const Headers &headers, Progress progress) {
